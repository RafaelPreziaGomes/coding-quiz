...
function removeElementsByClass(className) {
  ...
  function quizCycle() {
    startButton.addEventListener("click", () => {
      ...
      if (click > 0) {
        ...
        //first button of the first question
        firstBtn.addEventListener("click", () => {
          ...
          //<!-- ------------------------------ -->
          secondBtn1.addEventListener("click", () => {
            if (value == 0) {
              removeElementsByClass("qbtn");
              removeElementsByClass("question");
              removeElementsByClass("time");
          ...
          //////////////////////////////////////////////////////////
          thirdBtn1.addEventListener("click", () => {
            if (value == 0) {
              removeElementsByClass("qbtn");
              removeElementsByClass("question");
              removeElementsByClass("time");
          ...
          //////////////////////////////////////////////////////////
          fourthBtn1.addEventListener("click", () => {
            if (value == 0) {
              removeElementsByClass("qbtn");
              removeElementsByClass("question");
              removeElementsByClass("time");
        ...
        // add event listener to the buttons
        //second button of the first question
        ...
        //fourth button of the first question
  ...
  function initialQuestion() {
    ...
    fourthBtn.addEventListener("click", nextQuestion);
  }
